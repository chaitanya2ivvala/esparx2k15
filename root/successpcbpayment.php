...
if(isset($_POST["send"])){
	...
	if ($e_check > 0)
	{
		...
		$ExparxId= 'PCBWORKSHOP-'.rand(10000,99999);
		$sql = "update users set pcbworkshopID='".$ExparxId."' where email='".$e."'";
		$query = mysqli_query($db_conx, $sql);
		$sql2 = "update tbl_pcbworkshop set pcbworkshopID='".$ExparxId."',is_paid='1' where uid='".$_SESSION['userid']."'";
		mysqli_query($db_conx, $sql2);
                $to = "$e";
		
		$from = "info@esparx2k16.com";
		$subject = 'Esparx2k16:: PCB Worksshop ID created Successfull';
		$title="PCB Worksshop ID Created";
		$heading='Please check your WORKSHOP Id:';
		...
		header("location:successpcbpayment.php?id=success");
		
	}
	else
	{
	header("location:successpcbpayment.php?id=err");
        exit();
	}
	exit();
}
...
<div class="twitter" id="Partnershipd" style="background-color: #fff">
  <div class="container" style="background-color:#fff;margin-top: 40px;border: 1px solid #DDDDDD">
   ...
   <br>
	...
	{
	echo "<span style=color:green;>You have successfully registered for PCB Workshop. An email has been sent with PCB Workshop ID to your email id.";
	}
...
<form method="post">
<div class="twitter_left2" style="text-align:center">
	<p><b>Note:</b><span style=background-color:yellow;> Please enter your Userid which you used at the time of signup, We will send you a PCB Workshop Transaction number to this email id.</span></p><br>
</div>
<div class="twitter_left2" style="text-align:center">
