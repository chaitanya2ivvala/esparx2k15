...
$(".submit_buttonsolo").click(function()
{
 var name = $('input[name="namesolo[]"]').map(function() {
        return this.value
    }).get()
  var phone = $('input[name="phonesolo[]"]').map(function() {
        return this.value
    }).get()
    var address = $('input[name="addresssolo[]"]').map(function() {
        return this.value
    }).get()
...
var dataString = 'name='+name+'@@address='+address+'@@phone='+phone+'@@price='+fs+'@@tbl='+tbl;

$.ajax({
type: "POST",
url: "savedatasolo.php",
data: dataString,
cache: true,
success: function(html){
$('#flashsolo').show();
$("#flashsolo").fadeIn(400).html('<span class="load">Data saved successfully!</span>');
$('#flashsolo').delay(3000).fadeOut();
document.getElementById('namesolo').value='';
document.getElementById('addresssolo').value='';
document.getElementById('phonesolo').value='';
}  
});
...
$(".submit_buttongroup").click(function()
{
 var name = $('input[name="namegroup[]"]').map(function() {
        return this.value
    }).get()
  var phone = $('input[name="phonegroup[]"]').map(function() {
        return this.value
    }).get()
    var address = $('input[name="addressgroup[]"]').map(function() {
        return this.value
    }).get()
...
success: function(html){
$('#flashgroup').show();
$("#flashgroup").fadeIn(400).html('<span class="load">Data saved successfully!</span>');
$('#flashgroup').delay(3000).fadeOut();
document.getElementById('namegroup').value='';
document.getElementById('addressgroup').value='';
document.getElementById('phonegroup').value='';
}  
});
...
$(".submit_buttonluxury").click(function()
{
 var name = $('input[name="nameluxury[]"]').map(function() {
        return this.value
    }).get()
  var phone = $('input[name="phoneluxury[]"]').map(function() {
        return this.value
    }).get()
    var address = $('input[name="addressluxury[]"]').map(function() {
        return this.value
    }).get()
...
$.ajax({
type: "POST",
url: "saveaccomodation.php",
data: dataString,
cache: true,
success: function(html){
$('#flashluxury').show();
$("#flashluxury").fadeIn(400).html('<span class="load">Data saved successfully!</span>');
$('#flashluxury').delay(3000).fadeOut();
document.getElementById('nameluxury').value='';
document.getElementById('addressluxury').value='';
document.getElementById('phoneluxury').value='';
}  
});
...
$(".submit_buttonsemiluxury").click(function()
{
 var name = $('input[name="namesemiluxury[]"]').map(function() {
        return this.value
    }).get()
  var phone = $('input[name="phonesemiluxury[]"]').map(function() {
        return this.value
    }).get()
    var address = $('input[name="addresssemiluxury[]"]').map(function() {
        return this.value
    }).get()
...
cache: true,
success: function(html){
$('#flashsemiluxury').show();
$("#flashsemiluxury").fadeIn(400).html('<span class="load">Data saved successfully!</span>');
$('#flashsemiluxury').delay(3000).fadeOut();
document.getElementById('namesemiluxury').value='';
document.getElementById('addresssemiluxury').value='';
document.getElementById('phonesemiluxury').value='';
}  
});
...
$(".submit_buttoncomfort").click(function()
{
 var name = $('input[name="namecomfort[]"]').map(function() {
        return this.value
    }).get()
  var phone = $('input[name="phonecomfort[]"]').map(function() {
        return this.value
    }).get()
    var address = $('input[name="addresscomfort[]"]').map(function() {
        return this.value
    }).get()
...
success: function(html){
$('#flashcomfort').show();
$("#flashcomfort").fadeIn(400).html('<span class="load">Data saved successfully!</span>');
$('#flashcomfort').delay(3000).fadeOut();
document.getElementById('namecomfort').value='';
document.getElementById('addresscomfort').value='';
document.getElementById('phonecomfort').value='';
}  
});
...
$(".submit_buttoncomfortgirl").click(function()
{
 var name = $('input[name="namecomfortgirl[]"]').map(function() {
        return this.value
    }).get()
  var phone = $('input[name="phonecomfortgirl[]"]').map(function() {
        return this.value
    }).get()
    var address = $('input[name="addresscomfortgirl[]"]').map(function() {
        return this.value
    }).get()
...
cache: true,
success: function(html){
$('#flashcomfortgirl').show();
$("#flashcomfortgirl").fadeIn(400).html('<span class="load">Data saved successfully!</span>');
$('#flashcomfortgirl').delay(3000).fadeOut();
document.getElementById('namecomfortgirl').value='';
document.getElementById('addresscomfortgirl').value='';
document.getElementById('phonecomfortgirl').value='';
}  
});
...
$(".submit_buttonfood").click(function()
{
 var name = $('input[name="namefood[]"]').map(function() {
        return this.value
    }).get()
  var phone = $('input[name="phonefood[]"]').map(function() {
        return this.value
    }).get()
    var address = $('input[name="addressfood[]"]').map(function() {
        return this.value
    }).get()
...
success: function(html){
$('#flashfood').show();
$("#flashfood").fadeIn(400).html('<span class="load">Data saved successfully!</span>');
$('#flashfood').delay(3000).fadeOut();
document.getElementById('namefood').value='';
document.getElementById('addressfood').value='';
document.getElementById('phonefood').value='';
}  
});
  ...
  <div class="container">
    <div class="portfolio_top">
      ...
      <ul id="filters" class="clearfix">
         <li><span class="filter active" data-filter="Presentation Classify Workshops Coding Projects Robo Circuitrix GuestLectures Cultivo">All</span></li>
	...
	<li><span class="filter" data-filter="Cultivo">Cultivo</span></li>
      </ul>
      <div class="clear"></div>
    </div>
    <div id="portfoliolist">
      ...
      <div class="portfolio Cultivo mix_all" data-cat="Cultivo" style="display: inline-block; opacity: 1;">
        <div class="portfolio-wrapper"> <a href="#" class="b-link-stripe b-animate-go  thickbox" data-toggle="modal" data-target="#myModalCultivo"> <img src="../images/dance.png" />
          <div class="b-wrapper">
            <h2 class="b-animate b-from-left    b-delay03 "><img src="../images/plus.png" alt=""/></h2>
          </div>
          </a> </div>
...
<div>    
<div align="center">
	 <a href="pcbworkshop.php" style="background-color: #1CB4E5;padding:10px;color: #fff">Register</a>
</div>
</div>
...
<div>    
<div align="center">
	 <a href="sixthsense.php" style="background-color: #1CB4E5;padding:10px;color: #fff">Register</a>
</div>
</div>
          </div>
...
<div>    
<div align="center">
	 <a href="internetthings.php" style="background-color: #1CB4E5;padding:10px;color: #fff">Register</a>
</div>
</div>
          </div>
...
<div>    
<div align="center">
	 <a href="matlab.php" style="background-color: #1CB4E5;padding:10px;color: #fff">Register</a>
</div>
</div>
          </div>
...
<div id="upload-wrapper">
	<p>If your Abstract got selected, then you have to pay. Please click on below button to pay</p>
<div align="center">
	<div class="pm-button"><a href="https://www.payumoney.com/paybypayumoney/#/C6CCD15864BAFD05A10F77DD43A471CC"><img src="https://www.payumoney.com//media/images/payby_payumoney/buttons/112.png" /></a></div>
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <p><img src="images/Circuitrix.jpg" class="img-responsive"></p>
	    ...
	    <div style="background-color:#DDDDDD">    
<div id="upload-wrapper3">
<div align="center">
<h3>Upload Project Competition Presentation</h3>
...
<td>Email Id</td>
<tr>
<td><input type="text" name="fnamepr[]" class="fname" id="fname" class="form-control"></td>
<td><input type="text" name="lnamepr[]"  id="lname" class="form-control"></td>
<td><input type="text" name="collegepr[]" class="form-control"></td>
<td>
<select name="genderpr[]" class="form-control" id="gender">
  <option value="" selected>Gender</option>
  <option value="Male">Male</option>
  <option value="Female">Female</option>
</select>
...
<td>
<select name="yearpr[]" class="form-control">
  <option value="" selected>Year</option>
  <option value="I-year">I-year</option>
  <option value="II-year">II-year</option>
  <option value="III-year">III-year</option>
...
<td><input type="text" name="phonepr[]" class="form-control"></td>
<td><input type="text" name="emailpr[]" class="form-control"></td>
</tr>
<tr>
<td><input type="text" name="fnamepr[]" class="form-control"></td>
<td><input type="text" name="lnamepr[]" class="form-control"></td>
<td><input type="text" name="collegepr[]" class="form-control"></td>
<td>
<select name="genderpr[]" class="form-control">
  <option value="" selected>Gender</option>
  <option value="Male">Male</option>
  <option value="Female">Female</option>
</select>
...
<tr>
<td colspan="7" style="text-align: center"><input type="submit"  id="submit-btndd" value="Save Data" class="submit_buttonpr" style="background-color: #61BAE4;padding: 10px;border-radius: 5px;color:#fff;border: none" />
<div id="flashpr"></div>
<div id="showpr"></div></td>
</tr>
</table>
<div class="space"></div>
<input type="hidden" name="type" id="project"  value="Project" />
</form>



<form action="processupload.php" method="post" enctype="multipart/form-data" id="MyUploadForm3">
<input name="FileInput" id="FileInput3" type="file" />
<input type="hidden" name="type"  value="Project" />
<input type="submit"  id="submit-btn3" value="Upload data" />
<img src="images/ajax-loader.gif" id="loading-img" style="display:none;" alt="Please Wait"/>
</form>
...
<div id="upload-wrapper">
	<p>If your Abstract got selected, then you have to pay. Please click on below button to pay</p>
<div align="center">
	<div class="pm-button"><a href="https://www.payumoney.com/paybypayumoney/#/102701"><img src="https://www.payumoney.com//media/images/payby_payumoney/buttons/112.png" /></a></div>
</div>
</div>
</div>
          </div>
...
<div>    
<div align="center">
	 <a href="circuitrix.php" style="background-color: #1CB4E5;padding:10px;color: #fff">Register</a>
</div>
</div>
...
<!-- Modal Circuitrix -->
<div class="modal fade" id="myModalCultivo" role="dialog">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal">&times;</button>
        <h4 class="modal-title">Cultivo</h4>
      </div>
      <div class="modal-body">
        <ul class="nav nav-tabs">

          <li><a data-toggle="tab" href="#Cultivo2">Categories</a></li>
          <li><a data-toggle="tab" href="#Cultivo3">Contact Us</a></li>
        </ul>
        <div class="tab-content">
         
          <div id="Cultivo2" class="tab-pane fade in active">
          
          
            <p>&nbsp;</p>
           
            <h4>Solo dance performance:</h4>
           
              <p>The registration fee for Solo dance performance is 100 INR</p>
<div style="background-color:#DDDDDD">    
<div id="upload-wrapper">
<div align="center">
<form method="post" enctype="multipart/form-data" id="MyUploa">	
...
<td>Phone</td>
<tr>
<td><input type="text" name="namesolo[]"  id="namesolo" class="form-control"></td>
<td><input type="text" name="addresssolo[]"  id="addresssolo" class="form-control"></td>
<td><input type="text" name="phonesolo[]" id="phonesolo" class="form-control"></td>
</tr>
<tr>
<td colspan="7" style="text-align: center">
<input type="submit"  id="submit-btndd" value="Save Data" class="submit_buttonsolo" style="background-color: #61BAE4;padding: 10px;border-radius: 5px;color:#fff;border: none" />
<div id="flashsolo"></div>
<div id="showsolo"></div></td>
</tr>

</table>
</form>
<p><div class="pm-button"><a href="https://www.payumoney.com/paybypayumoney/#/74E1AF505A08A247C6A53C7D311AF458"><img src="https://www.payumoney.com//media/images/payby_payumoney/buttons/112.png" /></a></div></p>
</div>
</div>
</div>
            ...
            <hr>
            <h4>Group dance performance:</h4>
            <p>The registration fee for group dance performance is 250 INR</p>
	    <div style="background-color:#DDDDDD">    
<div id="upload-wrapper">
<div align="center">
<form method="post" enctype="multipart/form-data" id="MyUploa">	
...
<td>Phone</td>
<tr>
<td><input type="text" name="namegroup[]"  id="namegroup" class="form-control"></td>
<td><input type="text" name="addressgroup[]"  id="addressgroup" class="form-control"></td>
<td><input type="text" name="phonegroup[]" id="phonegroup" class="form-control"></td>
</tr>
<tr>
<td colspan="7" style="text-align: center">
<input type="submit"  id="submit-btndd" value="Save Data" class="submit_buttongroup" style="background-color: #61BAE4;padding: 10px;border-radius: 5px;color:#fff;border: none" />
<div id="flashgroup"></div>
<div id="showgroup"></div></td>
</tr>

</table>
</form>
<p><div class="pm-button"><a href="https://www.payumoney.com/paybypayumoney/#/41B04B913FFEC136109065F0690E9DFA"><img src="https://www.payumoney.com//media/images/payby_payumoney/buttons/112.png" /></a></div></p>
</div>
</div>
</div>
          ...
          <div id="Cultivo3" class="tab-pane fade">
            <hr>
            <h3>Contact</h3>
            <div class="address" style="background:#ff9900; padding:5px;">
              <p><b>Pavan </b> | Phone: +91 8341-612724</p>
              <p><b>Karthik </b>  | +91 9491-729398</p>
...
<td>Phone</td>
<tr>
<td><input type="text" name="nameluxury[]"  id="nameluxury" class="form-control"></td>
<td><input type="text" name="addressluxury[]"  id="addressluxury" class="form-control"></td>
<td><input type="text" name="phoneluxury[]" id="phoneluxury" class="form-control"></td>
</tr>
<tr>
<td colspan="7" style="text-align: center">
<input type="submit"  id="submit-btndd" value="Save Data" class="submit_buttonluxury" style="background-color: #61BAE4;padding: 10px;border-radius: 5px;color:#fff;border: none" />
<div id="flashluxury"></div>
<div id="showluxury"></div></td>
</tr>

</table>
</form>
<p><div class="pm-button"><a href="https://www.payumoney.com/paybypayumoney/#/102591"><img src="https://www.payumoney.com//media/images/payby_payumoney/buttons/112.png" /></a></div></p><br> </li>
...
<td>Phone</td>
<tr>
<td><input type="text" name="namesemiluxury[]"  id="namesemiluxury" class="form-control"></td>
<td><input type="text" name="addresssemiluxury[]"  id="addresssemiluxury" class="form-control"></td>
<td><input type="text" name="phonesemiluxury[]" id="phonesemiluxury" class="form-control"></td>
</tr>
<tr>
<td colspan="7" style="text-align: center">
<input type="submit"  id="submit-btndd" value="Save Data" class="submit_buttonsemiluxury" style="background-color: #61BAE4;padding: 10px;border-radius: 5px;color:#fff;border: none" />
<div id="flashsemiluxury"></div>
<div id="showsemiluxury"></div></td>
</tr>

</table>
</form>
<p><div class="pm-button"><a href="https://www.payumoney.com/paybypayumoney/#/102595"><img src="https://www.payumoney.com//media/images/payby_payumoney/buttons/112.png" /></a></div></p><br> </li>
...
<li>Comfort (Non A/C dormitory) - 100/- per day <br></li>	
<div style="background-color:#DDDDDD">    
<div id="upload-wrapper">
<div align="center">
<form method="post" enctype="multipart/form-data" id="MyUploa">	
...
<td>Phone</td>
<tr>
<td><input type="text" name="namecomfort[]"  id="namecomfort" class="form-control"></td>
<td><input type="text" name="addresscomfort[]"  id="addresscomfort" class="form-control"></td>
<td><input type="text" name="phonecomfort[]" id="phonecomfort" class="form-control"></td>
</tr>
<tr>
<td colspan="7" style="text-align: center">
<input type="submit"  id="submit-btndd" value="Save Data" class="submit_buttoncomfort" style="background-color: #61BAE4;padding: 10px;border-radius: 5px;color:#fff;border: none" />
<div id="flashcomfort"></div>
<div id="showcomfort"></div></td>
</tr>

</table>
</form>
<p><div class="pm-button"><a href="https://www.payumoney.com/paybypayumoney/#/102603"><img src="https://www.payumoney.com//media/images/payby_payumoney/buttons/112.png" /></a></div></p><br> </li>  				
</div>
</div>
</div>
	    ...
	    <hr>
	    <h3>Accommodation for Girls:</h3>
            <ol type="1">
		<li>Comfort level payment button:<br><p><div class="pm-button"><a href="https://www.payumoney.com/paybypayumoney/#/102603"><img src="https://www.payumoney.com//media/images/payby_payumoney/buttons/112.png" /></a></div></p><br></li>
		<div style="background-color:#DDDDDD">    
<div id="upload-wrapper">
<div align="center">
<form method="post" enctype="multipart/form-data" id="MyUploa">	
...
<td>Phone</td>
<tr>
<td><input type="text" name="namecomfortgirl[]"  id="namecomfortgirl" class="form-control"></td>
<td><input type="text" name="addresscomfortgirl[]"  id="addresscomfortgirl" class="form-control"></td>
<td><input type="text" name="phonecomfortgirl[]" id="phonecomfortgirl" class="form-control"></td>
</tr>
<tr>
<td colspan="7" style="text-align: center">
<input type="submit"  id="submit-btndd" value="Save Data" class="submit_buttoncomfortgirl" style="background-color: #61BAE4;padding: 10px;border-radius: 5px;color:#fff;border: none" />
<div id="flashcomfortgirl"></div>
<div id="showcomfortgirl"></div></td>
</tr>
...
<p>
<div class="pm-button"><a href="https://www.payumoney.com/paybypayumoney/#/06AB235237E5705B0BDF0CDD01B886C9"><img src="https://www.payumoney.com//media/images/payby_payumoney/buttons/112.png" /></a></div> 
</p>
<div style="background-color:#DDDDDD">    
<div id="upload-wrapper">
<div align="center">
...
<td>Phone</td>
<tr>
<td><input type="text" name="namefood[]"  id="namefood" class="form-control"></td>
<td><input type="text" name="addressfood[]"  id="addressfood" class="form-control"></td>
<td><input type="text" name="phonefood[]" id="phonefood" class="form-control"></td>
</tr>
<tr>
<td colspan="7" style="text-align: center">
<input type="submit"  id="submit-btndd" value="Save Data" class="submit_buttonfood" style="background-color: #61BAE4;padding: 10px;border-radius: 5px;color:#fff;border: none" />
<div id="flashfood"></div>
<div id="showfood"></div></td>
</tr>
