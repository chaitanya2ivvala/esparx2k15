...
<div class="twitter" id="Partnershipd" style="background-color: #fff">
  ...
  <div class="container" style="background-color:#fff;margin-top: 40px;border: 1px solid #DDDDDD">
    ...
    <div class="twitter_left2"></br>
      ...
      <center><h3 class="m_21" style="color: #fff;font-family: verdana;text-transform: none;background-color: #4BCAFF;padding: 10px;">Registration Error</h3></center>
...
<form>
	...
	<p><span style=color:red;>Opps, User with the given email Id is already exist.</span></p><br>
