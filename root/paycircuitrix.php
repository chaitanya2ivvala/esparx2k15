...
if(isset($_POST['save']))
{
	 ...
	 { ?>
	 <script>
	  window.location.href="errorcircuitrix.php";
	 </script>
	<?php
	 }
}
...
<div class="twitter" id="Partnershipd" style="background-color: #fff">
  <div class="container" style="background-color:#fff;margin-top: 40px;border: 1px solid #DDDDDD">
    <div class="twitter_left2"></br>
      <center><h3 class="m_21" style="color: #fff;font-family: verdana;text-transform: none;background-color: #4BCAFF;padding: 10px;">Circuitrix  Payment process</h3></center>
...
<div class="pm-button"><a href="https://www.payumoney.com/paybypayumoney/#/102707"><img src="https://www.payumoney.com//media/images/payby_payumoney/buttons/112.png" /></a></div>
</div><br><br>
</form>
...
<div class="modal fade" id="myModalCoding" role="dialog">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal">&times;</button>
        <h4 class="modal-title">Circuitrix Workshop</h4>
      </div>
      <div class="modal-body">
        <ul class="nav nav-tabs">
          <!-- <li><a data-toggle="tab" href="#home">Home</a></li>-->
