...
<div class="twitter" id="Partnershipd" style="background-color: #fff">
  <div class="container" style="background-color:#DDDDDD;margin-top: 40px">
    <div class="twitter_left2"></br>
      <center><h3 class="m_21" style="color: #777777;font-family: verdana;text-transform: none">Sixth Sense Registration</h3></center>
      
    </div>
   <br><br>
<form method="post" action="paysixthsense.php">
...
$(function(){
	 ...
	 {
	 alert("Sorry!! you can not add more than 5 users");	
	 }
