...
if(isset($_POST["save"])){ 
  ...
  $ip = preg_replace('#[^0-9.]#', '', getenv('REMOTE_ADDR'));
	...
	// -------------------------------------------
	$sql = "SELECT id FROM users WHERE email='$e' AND is_paid='1' AND activated='1' LIMIT 1";
        $query = mysqli_query($db_conx, $sql); 
	...
	{ 
	 ...
	 {
        $m='firstname cannot begin with a number';
         }
	 else if (is_numeric($l[0])) {
        $m='lastname cannot begin with a number';
       
		} else {
	// END FORM DATA ERROR HANDLING
	    // Begin Insertion of data into the database
		$p_hash = md5($_POST['p1']);
		                $sql2 = "delete from users where email='".$e."' AND is_paid='0' AND activated='0'";
		...
		$m="<p style=color:green>Please click on below link to make the payment.</p>";
...
<div class="twitter" id="Partnershipd" style="background-color: #fff">
  <div class="container" style="background-color:#fff;margin-top: 40px;border: 1px solid #DDDDDD">
    <div class="twitter_left2"></br>
      <center><h3 class="m_21" style="color: #fff;font-family: verdana;text-transform: none;background-color: #4BCAFF;padding: 10px;">Payment Process</h3></center>
...
<form>
	<div class="twitter_left2" style="text-align:center">
	<p><span style=background-color:yellow;>Please pay INR 200 for successful registration. Please click on below button to pay through Payumoney payment gateway.</span></p><br>
</div>
<div class="twitter_left2" style="text-align:center">     <div class="pm-button"><a href="https://www.payumoney.com/paybypayumoney/#/101293"><img src="https://www.payumoney.com//media/images/payby_payumoney/buttons/112.png" /></a></div>
</div><br><br>
</form>
