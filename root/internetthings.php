...
<div class="twitter" id="Partnershipd" style="background-color: #fff">
  <div class="container" style="background-color:#DDDDDD;margin-top: 40px">
    <div class="twitter_left2"></br>
      <center><h3 class="m_21" style="color: #777777;font-family: verdana;text-transform: none">Internet of Things Registration</h3></center>
      
    </div>
   <br><br>
<form method="post" action="payinternetthings.php">
