...
if(isset($_POST['save']))
{
	 ...
	 { ?>
	 <script>
	  window.location.href="errorinternetthings.php";
	 </script>
	<?php
	 }
}
...
<div class="twitter" id="Partnershipd" style="background-color: #fff">
  <div class="container" style="background-color:#fff;margin-top: 40px;border: 1px solid #DDDDDD">
    <div class="twitter_left2"></br>
      <center><h3 class="m_21" style="color: #fff;font-family: verdana;text-transform: none;background-color: #4BCAFF;padding: 10px;">Internet of things Payment Process</h3></center>
...
<form>
	<div class="twitter_left2" style="text-align:center">
	<p><span style=background-color:yellow;>Please pay INR 6000 for successful IOT registration. Please click on below button to pay through Payumoney payment gateway.</span></p><br>
</div>
<div class="twitter_left2" style="text-align:center">    <div class="pm-button"><a href="https://www.payumoney.com/paybypayumoney/#/279ED0E5C62283311A79AD1CF1F34B69"><img src="https://www.payumoney.com//media/images/payby_payumoney/buttons/112.png" /></a></div>
</div><br><br>
</form>
