...
<div class="header">
  ...
  <div class="header-bottom" id="home">
    ...
    <div class="buttons-box"> <a  class="btn btn-f-default smoothanchor" href="http://www.esparx2k16.com/root/login.php">Login</a> <a  class="btn btn-f-default smoothanchor" href="http://www.esparx2k16.com/root/signup.php">Register</a> </div>
  </div>
</div>
<!--end header-->
  ...
  <div class="container">
    <div class="portfolio_top">
      ...
      <ul id="filters" class="clearfix">
        ...
        <li><span class="filter" data-filter="GuestLectures">Startup India</span></li>
...
<div class="modal fade" id="myModalWorkshops" role="dialog">
 ...
 <li>Multimeter(Only during workshop)</li>
	    ...
	    <a href="pcbworkshop.php" style="background-color:#1CB4E5;padding: 10px;">Register</a>
          </div>
    ...
    <div class="col-xs-6 col-sm-3">
        <a href="#" class="thumbnail" data-toggle="modal" data-target="#lightbox"> 
          ...
          <div id="Hospitalityboys3" class="tab-pane fade">
            ...
            <ol type="1">
		<li>Luxury(A/C room with TV) - 220/- per day <br> <p><div class="pm-button"><a href="https://www.payumoney.com/paybypayumoney/#/102591"><img src="https://www.payumoney.com//media/images/payby_payumoney/buttons/112.png" /></a></div></p><br> </li>
		<li>Semi Luxury (A/C dormitory) - 170/- per day <br> <p><div class="pm-button"><a href="https://www.payumoney.com/paybypayumoney/#/102595"><img src="https://www.payumoney.com//media/images/payby_payumoney/buttons/112.png" /></a></div></p><br> </li>
		<li>Comfort (Non A/C dormitory) - 100/- per day <br><p><div class="pm-button"><a href="https://www.payumoney.com/paybypayumoney/#/102603"><img src="https://www.payumoney.com//media/images/payby_payumoney/buttons/112.png" /></a></div></p><br> </li>  
	    </ol>
	    <hr>
...
Pay 250/- to order food for 2-days <br><br>
<p>
