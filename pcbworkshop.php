...
<div class="twitter" id="Partnershipd" style="background-color: #fff">
  <div class="container" style="background-color:#DDDDDD;margin-top: 40px">
    <div class="twitter_left2"></br>
      <center><h3 class="m_21" style="color: #777777;font-family: verdana;text-transform: none">PCB Workshop Registration</h3></center>
...
<tr class="tr-header">
<th style="background-color: #F5F5F5">First Name</th>
<th style="background-color: #F5F5F5">Last Name</th>
<th style="background-color: #F5F5F5">College</th>
<th style="background-color: #F5F5F5">Gender</th>
<th style="background-color: #F5F5F5">Study Year</th>
<th style="background-color: #F5F5F5">Contact No</th>
<th style="background-color: #F5F5F5">Email Id</th>
<th style="background-color: #F5F5F5"><a href="javascript:void(0);" style="font-size:18px;" id="addMore" title="Add More Person"><img src="images/add.png"></a></th>
<tr>
...
<select name="gender[]" class="form-control">
  ...
  <option value="Accountant">Female</option>
</select>
</td>
<td>
<select name="year[]" class="form-control">
  <option value="" selected>Study Year</option>
  <option value="Engineer">2015</option>
  <option value="Accountant">2016</option>
</select>
</td>
<td><input type="text" name="mobileno[]" class="form-control"></td>
<td><input type="text" name="emailid[]" class="form-control"></td>
<td><a href='javascript:void(0);'  class='remove'><img src="images/del.png"></a></td>
</tr>
</table>
<div class="twitter_left2" style="text-align:center">
      <input type="submit"  name="save" value="Click To Save" style="background-color:#1CB4E5;padding: 10px;">
 </div>
</form>
...
$(function(){
	 ...
	 {
	 alert("Sorry!! you can not add more than 4 users");	
	 }
